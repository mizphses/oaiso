...
class CheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post checkouts_url, params: { checkout: { itemid: @checkout.itemid, shopid: @checkout.shopid, userid: @checkout.userid } }
    end
  ...
  test "should update checkout" do
    patch checkout_url(@checkout), params: { checkout: { itemid: @checkout.itemid, shopid: @checkout.shopid, userid: @checkout.userid } }
